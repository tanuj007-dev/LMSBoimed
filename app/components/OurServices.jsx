      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[#0088ff] font-bold tracking-widest text-[10px] uppercase">
              Our Services
            </span>
          </div>
          ...
          <p className="max-w-2xl text-gray-500 text-[12px] md:text-sm leading-relaxed font-poppins opacity-90">
            We revolutionize the path from knowledge to career, bridging skills
            gaps to build a future-ready workforce and deliver proven value to
            industry partners.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 items-center">
          ...
          <div className="flex flex-col order-2 lg:order-1">
            <ServiceItem
              ...
              description="Biomed Canada's key advantage lies in its centralized, end-to-end clinical trial management, which leverages deep expertise in both the Canadian and global regulatory landscape and a well-established network of medical sites to deliver efficient, compliant, and high-quality study execution."
            />
            <ServiceItem
              index={1}
          ...
          <div className="flex flex-col order-3 lg:order-3">
            <ServiceItem
              ...
              description="Our highly qualified healthcare, research, and medical professionals analyze the outcome of new required skills and constantly update the review materials to reflect changes highly needed by the global medico-pharmaceutical industry."
            />
            <ServiceItem
              index={3}
